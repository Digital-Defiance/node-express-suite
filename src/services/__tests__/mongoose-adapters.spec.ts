...
describe('MongooseDatabase has all IDatabase methods', () => {
  ...
  it('is structurally assignable to IDatabase at compile time', () => {
    // This function is never called — it exists purely for the TypeScript
    // compiler to verify that MongooseDatabase satisfies IDatabase.
...
describe('MongooseSessionAdapter has all IClientSession members', () => {
  ...
  // 'id' and 'inTransaction' are getter properties, not plain methods.
  // Verify they are defined as accessors on the prototype.
