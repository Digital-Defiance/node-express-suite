/**
 * @fileoverview Simple XOR cipher service for obfuscating data in memory.
 * Provides lightweight protection against plaintext storage without strong cryptography.
 * @module services/xor
 */
...
export class XorService {
   ...
   * @param key Key to use for the XOR operation
